...
class ApiController extends Controller
{
    ...
    public function save_category(Request $request)
    {
        ...
        $categories = Category::create([
            ...
            'less_assign'=>($request->less_assign==true?'1':''),
            'location'=>($request->location==true?'1':''),
            'last_assign'=>($request->last_assign==true?'1':''),
            'price'=>$request->price,
            'maximum_rating'=>($request->maximum_rating==true?'1':''),
            'image'=>$file_name
    ...
    {
        $categories = Sub_category::create([
    ...
    public function updateCategory(Request $request)
    {
        ...
        if($data!=''){
            ...
            $data->less_assign = ($request->less_assign==true||1?'1':'');
            $data->last_assign = ($request->last_assign==true||1?'1':'');
            $data->location = ($request->location==true||1?'1':'');
            $data->maximum_rating = ($request->maximum_rating==true||1?'1':'');
